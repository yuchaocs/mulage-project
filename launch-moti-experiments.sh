...
do
	...
	do
		...
		echo "copy experiment results to experiments/moti/${policy}/${input}"
		cp $latency_result_file ../experiments/moti/${policy}/${input}
		cp $delay_result_file ../experiments/moti/${policy}/${input}
		cd - > /dev/null
